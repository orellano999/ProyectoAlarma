...
import com.example.proyectoalarma.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun Cambiar_Camara(cameraSelector: CameraSelector) {
            ...
            .start(ContextCompat.getMainExecutor(this)) { recordEvent ->
                when(recordEvent) {
                    ...
                    is VideoRecordEvent.Finalize -> {
                        ...
                        viewBinding.CambiarCamara.isEnabled = true//
    ...
    companion object {
        private const val TAG = "ProyectoAlarma"
